...
$dbname = "zhas3660";
echo "<form action=\"selectplayer.php\" method=post>";
	...
	{
	   echo "Player Name: <select name=\"name\">";
	...
	{
		echo "<p> No players Currently in database to show</p>"; 
...
try {
     ...
     $stmt = $conn->prepare("SELECT name, id FROM PLAYER");
     $stmt->execute();
